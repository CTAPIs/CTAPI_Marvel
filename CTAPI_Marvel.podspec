...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is CTAPI_Marvel
                   DESC

  s.homepage     = "https://github.com/casatwy/CTAPI_Marvel"
  ...
  s.source       = { :git => "https://github.com/casatwy/CTAPI_Marvel.git", :tag => s.version.to_s }
  ...
  s.source_files  = "CTAPI_Marvel/CTAPI_Marvel/**/*.{h,m}"
